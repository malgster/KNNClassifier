...
/**
 * tests the methods of EuclidianDistance
 */
public class EuclidianDistanceTest {
    ...
    void euclidian_distance_Test() {
        assertEquals(0.218, new EuclidianDistance().calculateDistance(testDataSet.getPoint(0), testDataSet.getPoint(1), testDataSet, testDataSet));
        assertEquals(0.221, new EuclidianDistance().calculateDistance(testDataSet.getPoint(0), testDataSet.getPoint(3), testDataSet, testDataSet));
        assertEquals(0.251, new EuclidianDistance().calculateDistance(testDataSet.getPoint(1), testDataSet.getPoint(4), testDataSet, testDataSet));
        assertEquals(0.375, new EuclidianDistance().calculateDistance(testDataSet.getPoint(2), testDataSet.getPoint(5), testDataSet, testDataSet));
    }
