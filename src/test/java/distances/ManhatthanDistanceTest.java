...
public class ManhatthanDistanceTest {
    ...
    void manhatthan_distance_test(){
        assertEquals(0.150, new ManhatthanDistance().calculateDistance(testDataSet.getMyPoints().get(1), testDataSet.getMyPoints().get(2), testDataSet));
        assertEquals(0.7, new ManhatthanDistance().calculateDistance(testDataSet.getMyPoints().get(1), testDataSet.getMyPoints().get(5), testDataSet));
        assertEquals(0.34, new ManhatthanDistance().calculateDistance(testDataSet.getMyPoints().get(3), testDataSet.getMyPoints().get(4), testDataSet));
        assertEquals(0.239, new ManhatthanDistance().calculateDistance(testDataSet.getMyPoints().get(2), testDataSet.getMyPoints().get(0), testDataSet));
    }
